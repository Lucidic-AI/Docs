...
```bash
curl -X POST https://api.lucidic.ai/v1/evosims \
...
```bash
curl https://api.lucidic.ai/v1/evosims/evosim_xyz789 \
  -H "Authorization: Bearer $LUCIDIC_API_KEY"
```
...
```bash
curl -X POST https://api.lucidic.ai/v1/evosims/evosim_xyz789/run \
  -H "Authorization: Bearer $LUCIDIC_API_KEY"
```
...
```bash
curl -X POST https://api.lucidic.ai/v1/evosims/evosim_xyz789/stop \
  -H "Authorization: Bearer $LUCIDIC_API_KEY"
```
...
```bash
curl https://api.lucidic.ai/v1/evosims/evosim_xyz789/status \
  -H "Authorization: Bearer $LUCIDIC_API_KEY"
```
...
```bash
curl https://api.lucidic.ai/v1/evosims/evosim_xyz789/results \
  -H "Authorization: Bearer $LUCIDIC_API_KEY"
```
...
```bash
curl https://api.lucidic.ai/v1/evosims/evosim_xyz789/best-config \
  -H "Authorization: Bearer $LUCIDIC_API_KEY"
```
...
```bash
curl https://api.lucidic.ai/v1/evosims/evosim_xyz789/insights \
  -H "Authorization: Bearer $LUCIDIC_API_KEY"
```
...
```bash
curl https://api.lucidic.ai/v1/evosims/evosim_xyz789/next-steps \
  -H "Authorization: Bearer $LUCIDIC_API_KEY"
```
...
```bash
curl -X POST https://api.lucidic.ai/v1/evosims/evosim_xyz789/compare \
  -H "Authorization: Bearer $LUCIDIC_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "config_ids": ["config_baseline", "config_iteration_49"]
