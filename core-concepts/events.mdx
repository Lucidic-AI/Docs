...
> 📷 _**[Insert UI screenshot of an expanded step showing a list of nested events here]**_
...
> 📷 _**[Insert graphical view of the above example from the dashboard UI]**_
...
> 📷 _**[Insert UI snippet showing raw and summarized event info side-by-side]**_
