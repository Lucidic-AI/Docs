...
- [`update_step`](/api-reference/api_functions/update_step) - Update step during execution
- [`end_session`](/api-reference/api_functions/end_session) - End the entire session