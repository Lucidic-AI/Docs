...
- [`update_step`](/api-reference/api_functions/update_step) - Update an existing step
- [`end_step`](/api-reference/api_functions/end_step) - End the current step
- [`create_event`](/api-reference/api_functions/create_event) - Create events within a step