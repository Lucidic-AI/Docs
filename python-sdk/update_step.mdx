...
- [`create_step`](/api-reference/api_functions/create_step) - Create a new step
- [`end_step`](/api-reference/api_functions/end_step) - End the current step
- [`get_decorator_step`](/api-reference/api_functions/decorators) - Get step ID in decorated functions