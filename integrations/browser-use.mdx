...
---
### 4. Example Script 
Perfect — since your full script is already available on GitHub, your docs section should focus on **highlighting specific capabilities** using short, labeled code snippets, not showing everything at once.

Here’s a revised **“Example Script”** section that explains the value, links to your repo, and then breaks things down into focused, readable snippets:
