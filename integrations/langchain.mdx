...
- `description`: LLM method or chain origin
- `model`: if available (e.g. `gpt-4`)
- `cost`: if token counts are available
- `result`: response text or summary
- Timing and success metadata

> 📷 _**[Insert screenshot of LangChain-generated event in the step view]**_
