...
| `lucidic_api_key` | `str` | Your Lucidic API key – you should have this copied somewhere safe           |
| `agent_id`      | `str`  | Your Lucidic Agent ID – you can get this from the dashboard                 |
