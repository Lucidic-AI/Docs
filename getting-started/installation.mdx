...
---
> 🧠 **Note:** Setup has three parts — (1) installing the SDK (below), (2) connecting it to the Lucidic [dashboard](/getting-started/dashboard), and (3) [setting up steps, events, and sessions](/getting-started/python). You need to complete all three.
