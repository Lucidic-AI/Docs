...
---
> **Note:** Setup has three parts — (1) installing the SDK (below), (2) connecting it to the Lucidic [dashboard](/getting-started/dashboard), and (3) [adding 2 lines to your code](/getting-started/quickstart). You need to complete all three.
