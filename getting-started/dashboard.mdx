...
---
> 🧠 **Note:** Setup has three parts — (1) [installing the SDK](/getting-started/installation), (2) connecting it to the Lucidic dashboard (below), and (3) [setting up steps, events, and sessions](/getting-started/python). You need to complete all three.
