...
<Columns cols={3}>
    <Card title="Tracing" icon="chart-gantt" href="/feature-overview/workflow-sandbox">
    ...
    <Card title="Prompts" icon="folder-open" href="/feature-overview/prompt-db">
        + Version control
...
- Analyze individual [Sessions](/feature-overview/workflow-sandbox) of agent behavior
- Inspect each [Event](/feature-overview/events) within your session trace
- Run [Experiments](/feature-overview/experiments) to observe variability at scale
- Define structured, flexible [Rubric Evaluations](/feature-overview/rubrics)
- Version and experiment with prompts via [Prompt DB](/feature-overview/prompt-db)
- Debug stuck logic using [Time Travel](/feature-overview/time-travel)
...
- **[Quick Start](/getting-started/quickstart)** — Add a few lines of code to track your agents
