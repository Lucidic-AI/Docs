...
with client.sessions.create(
    ...
    client.sessions.update(
        is_successful=True,
        is_successful_reason="Login successful, minor UI delay"
    )
...
await client.sessions.create({
    ...
    await client.sessions.update({
        isSuccessful: true,
        isSuccessfulReason: "Login successful, minor UI delay"
    });
});
...
for query in test_queries:
    ...
    with client.sessions.create(
        ...
        client.sessions.update(is_successful=score_a >= 7)
    ...
    with client.sessions.create(
        ...
        client.sessions.update(is_successful=score_b >= 7)
