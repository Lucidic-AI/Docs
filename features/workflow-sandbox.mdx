...
The **Workflow Sandbox** is your deep-dive view into a single agent run — also known as a [Session](/sessions). Learn to create one [here](/getting-started/final-instructions).
