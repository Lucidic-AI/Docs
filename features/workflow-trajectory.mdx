...
- **Node size** = how many sessions visited that state
- **Edge thickness** = how frequently that transition occurred
- **Graph shape** = the structural behavior of your agent (linear, branching, looping, etc.)

> 📷 _**[Insert full view of a Workflow Trajectory graph from your UI here]**_
...
> 📷 _**[Insert small diagram showing this kind of state merge and fork]**_
...
- Use **highlighting tools** (coming soon) to emphasize successful vs failed paths

> 📷 _**[Insert UI screenshot of a node being clicked, showing side panel with session list]**_
...
> 📷 _**[Insert graph with % labels or color-coded edge probabilities]**_

---

## 🔮 Planned Upgrades

- **Auto-tagging of suspicious patterns** (e.g. loops, frequent revisits)
- **Overlay evaluation scores** on nodes
- **Compare trajectory graphs** across different simulations
- **Graph diffs** for prompt/model comparisons
- **Custom clustering strategies** beyond just state equivalence
